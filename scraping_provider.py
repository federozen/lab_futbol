...
# Respaldo editorial autocontenido (Fecha 9, 14/09/2026).
# Se mantiene dentro de este archivo para que un deploy por GitHub no dependa
# de agregar modulos/JSON nuevos: una respuesta web parcial nunca puede bajar
# de esta foto verificada.
BOOTSTRAP_SAVED_AT = '2026-09-14T15:59:00-03:00'
_BOOTSTRAP_SEED = (
    (1, 'Belgrano', 'Rosario Central', '2026-07-23T23:59:00-03:00', 'played', 2, 1),
    (1, 'Sarmiento', 'Argentinos Juniors', '2026-07-23T23:59:00-03:00', 'played', 2, 3),
    (1, 'Defensa y Justicia', 'Aldosivi', '2026-07-23T23:59:00-03:00', 'played', 1, 1),
    (1, 'Gimnasia de Mendoza', 'Central Córdoba', '2026-07-24T23:59:00-03:00', 'played', 1, 0),
    (1, 'Racing', 'Gimnasia La Plata', '2026-07-24T23:59:00-03:00', 'played', 2, 1),
    (1, 'Vélez Sarsfield', 'Instituto', '2026-07-24T23:59:00-03:00', 'played', 1, 0),
    (1, 'Huracán', 'Banfield', '2026-07-24T23:59:00-03:00', 'played', 1, 0),
    (1, 'Platense', 'Unión', '2026-07-24T23:59:00-03:00', 'played', 2, 2),
    (1, 'Estudiantes de Río Cuarto', 'Tigre', '2026-07-25T23:59:00-03:00', 'played', 1, 0),
    (1, "Newell's Old Boys", 'Talleres', '2026-07-25T23:59:00-03:00', 'played', 1, 0),
    (1, 'River Plate', 'Barracas Central', '2026-07-25T23:59:00-03:00', 'played', 0, 1),
    (1, 'Lanús', 'San Lorenzo', '2026-07-25T23:59:00-03:00', 'played', 1, 0),
    (1, 'Atlético Tucumán', 'Independiente Rivadavia', '2026-07-26T23:59:00-03:00', 'played', 0, 0),
    (1, 'Estudiantes de La Plata', 'Independiente', '2026-07-26T23:59:00-03:00', 'played', 0, 2),
    (1, 'Deportivo Riestra', 'Boca Juniors', '2026-07-26T23:59:00-03:00', 'played', 3, 0),
    (2, 'San Lorenzo', 'Gimnasia de Mendoza', '2026-07-28T23:59:00-03:00', 'played', 1, 0),
    (2, 'Banfield', 'Sarmiento', '2026-07-28T23:59:00-03:00', 'played', 3, 2),
    (2, 'Argentinos Juniors', 'Estudiantes de Río Cuarto', '2026-07-28T23:59:00-03:00', 'played', 3, 0),
    (2, 'Rosario Central', 'Racing', '2026-07-28T23:59:00-03:00', 'played', 0, 0),
    (2, 'Barracas Central', 'Aldosivi', '2026-07-29T23:59:00-03:00', 'played', 1, 0),
    (2, 'Defensa y Justicia', 'Deportivo Riestra', '2026-07-29T23:59:00-03:00', 'played', 2, 1),
    (2, 'Gimnasia La Plata', 'River Plate', '2026-07-29T23:59:00-03:00', 'played', 1, 0),
    (2, 'Instituto', 'Platense', '2026-07-29T23:59:00-03:00', 'played', 2, 1),
    (2, 'Independiente Rivadavia', 'Huracán', '2026-07-30T23:59:00-03:00', 'played', 2, 1),
    (2, 'Talleres', 'Vélez Sarsfield', '2026-07-30T23:59:00-03:00', 'played', 1, 3),
    (2, 'Independiente', "Newell's Old Boys", '2026-07-30T23:59:00-03:00', 'played', 1, 0),
    (2, 'Central Córdoba', 'Atlético Tucumán', '2026-07-30T23:59:00-03:00', 'played', 0, 2),
    (2, 'Boca Juniors', 'Estudiantes de La Plata', '2026-08-05T23:59:00-03:00', 'played', 1, 0),
    (2, 'Tigre', 'Belgrano', '2026-08-05T23:59:00-03:00', 'played', 0, 0),
    (2, 'Unión', 'Lanús', '2026-08-06T23:59:00-03:00', 'played', 2, 1),
    (3, 'Gimnasia de Mendoza', 'Unión', '2026-08-01T23:59:00-03:00', 'played', 2, 0),
    (3, 'Estudiantes de Río Cuarto', 'Banfield', '2026-08-01T23:59:00-03:00', 'played', 0, 0),
    (3, 'Belgrano', 'Argentinos Juniors', '2026-08-01T23:59:00-03:00', 'played', 0, 1),
    (3, 'Estudiantes de La Plata', 'Defensa y Justicia', '2026-08-01T23:59:00-03:00', 'played', 3, 0),
    (3, 'Racing', 'Tigre', '2026-08-01T23:59:00-03:00', 'played', 1, 3),
    (3, 'Deportivo Riestra', 'Barracas Central', '2026-08-02T23:59:00-03:00', 'played', 0, 1),
    (3, 'Aldosivi', 'Gimnasia La Plata', '2026-08-02T23:59:00-03:00', 'played', 1, 2),
    (3, "Newell's Old Boys", 'Boca Juniors', '2026-08-02T23:59:00-03:00', 'played', 2, 2),
    (3, 'River Plate', 'Rosario Central', '2026-08-02T23:59:00-03:00', 'played', 0, 1),
    (3, 'Lanús', 'Instituto', '2026-08-02T23:59:00-03:00', 'played', 0, 1),
    (3, 'Sarmiento', 'Independiente Rivadavia', '2026-08-03T23:59:00-03:00', 'played', 2, 1),
    (3, 'Platense', 'Talleres', '2026-08-03T23:59:00-03:00', 'played', 0, 4),
    (3, 'Vélez Sarsfield', 'Independiente', '2026-08-03T23:59:00-03:00', 'played', 1, 0),
    (3, 'Central Córdoba', 'San Lorenzo', '2026-08-03T23:59:00-03:00', 'played', 1, 0),
    (3, 'Huracán', 'Atlético Tucumán', '2026-08-03T23:59:00-03:00', 'played', 0, 0),
    (4, 'Rosario Central', 'Aldosivi', '2026-08-07T23:59:00-03:00', 'played', 2, 1),
    (4, 'Independiente Rivadavia', 'Estudiantes de Río Cuarto', '2026-08-07T23:59:00-03:00', 'played', 2, 1),
    (4, 'Deportivo Riestra', 'Estudiantes de La Plata', '2026-08-08T23:59:00-03:00', 'played', 2, 0),
    (4, 'Atlético Tucumán', 'Sarmiento', '2026-08-08T23:59:00-03:00', 'played', 1, 2),
    (4, 'Tigre', 'River Plate', '2026-08-08T23:59:00-03:00', 'played', 1, 0),
    (4, 'Boca Juniors', 'Vélez Sarsfield', '2026-08-08T23:59:00-03:00', 'played', 1, 1),
    (4, 'Independiente', 'Platense', '2026-08-08T23:59:00-03:00', 'played', 0, 1),
    (4, 'Instituto', 'Gimnasia de Mendoza', '2026-08-08T23:59:00-03:00', 'played', 1, 0),
    (4, 'San Lorenzo', 'Huracán', '2026-08-09T23:59:00-03:00', 'played', 0, 2),
    (4, 'Defensa y Justicia', "Newell's Old Boys", '2026-08-09T23:59:00-03:00', 'played', 2, 1),
    (4, 'Gimnasia La Plata', 'Barracas Central', '2026-08-09T23:59:00-03:00', 'played', 2, 0),
    (4, 'Argentinos Juniors', 'Racing', '2026-08-09T23:59:00-03:00', 'played', 2, 1),
    (4, 'Banfield', 'Belgrano', '2026-08-10T23:59:00-03:00', 'played', 0, 2),
    (4, 'Unión', 'Central Córdoba', '2026-08-10T23:59:00-03:00', 'played', 1, 2),
    (4, 'Talleres', 'Lanús', '2026-08-11T23:59:00-03:00', 'played', 0, 3),
    (5, 'Racing', 'Banfield', '2026-08-14T23:59:00-03:00', 'played', 0, 1),
    (5, 'Aldosivi', 'Tigre', '2026-08-15T23:59:00-03:00', 'played', 0, 0),
    (5, 'San Lorenzo', 'Unión', '2026-08-15T23:59:00-03:00', 'played', 1, 0),
    (5, 'Estudiantes de La Plata', 'Gimnasia La Plata', '2026-08-15T23:59:00-03:00', 'played', 4, 0),
    (5, "Newell's Old Boys", 'Deportivo Riestra', '2026-08-15T23:59:00-03:00', 'played', 2, 0),
    (5, 'Belgrano', 'Independiente Rivadavia', '2026-08-15T23:59:00-03:00', 'played', 2, 0),
    (5, 'Platense', 'Boca Juniors', '2026-08-15T23:59:00-03:00', 'played', 1, 1),
    (5, 'Sarmiento', 'Huracán', '2026-08-16T23:59:00-03:00', 'played', 2, 0),
    (5, 'River Plate', 'Argentinos Juniors', '2026-08-16T23:59:00-03:00', 'played', 2, 0),
    (5, 'Barracas Central', 'Rosario Central', '2026-08-16T23:59:00-03:00', 'played', 0, 1),
    (5, 'Central Córdoba', 'Instituto', '2026-08-16T23:59:00-03:00', 'played', 0, 1),
    (5, 'Estudiantes de Río Cuarto', 'Atlético Tucumán', '2026-08-17T23:59:00-03:00', 'played', 0, 1),
    (5, 'Lanús', 'Independiente', '2026-08-17T23:59:00-03:00', 'played', 1, 3),
    (5, 'Vélez Sarsfield', 'Defensa y Justicia', '2026-08-17T23:59:00-03:00', 'played', 1, 1),
    (5, 'Gimnasia de Mendoza', 'Talleres', '2026-08-17T23:59:00-03:00', 'played', 3, 1),
    (6, 'Aldosivi', 'Unión', '2026-08-21T23:59:00-03:00', 'played', 1, 3),
    (6, 'Estudiantes de Río Cuarto', 'San Lorenzo', '2026-08-21T23:59:00-03:00', 'played', 0, 0),
    (6, 'Gimnasia La Plata', 'Gimnasia de Mendoza', '2026-08-22T23:59:00-03:00', 'played', 2, 3),
    (6, 'Atlético Tucumán', 'Instituto', '2026-08-22T23:59:00-03:00', 'played', 0, 0),
    (6, 'Independiente', 'Independiente Rivadavia', '2026-08-22T23:59:00-03:00', 'played', 0, 0),
    (6, "Newell's Old Boys", 'Banfield', '2026-08-22T23:59:00-03:00', 'played', 2, 1),
    (6, 'Huracán', 'Deportivo Riestra', '2026-08-22T23:59:00-03:00', 'played', 0, 0),
    (6, 'Sarmiento', 'Estudiantes de La Plata', '2026-08-23T23:59:00-03:00', 'played', 2, 0),
    (6, 'Barracas Central', 'Platense', '2026-08-23T23:59:00-03:00', 'played', 1, 2),
    (6, 'Belgrano', 'Defensa y Justicia', '2026-08-23T23:59:00-03:00', 'played', 1, 2),
    (6, 'River Plate', 'Vélez Sarsfield', '2026-08-23T23:59:00-03:00', 'played', 2, 2),
    (6, 'Racing', 'Boca Juniors', '2026-08-23T23:59:00-03:00', 'played', 1, 1),
    (6, 'Tigre', 'Central Córdoba', '2026-08-24T23:59:00-03:00', 'played', 2, 1),
    (6, 'Lanús', 'Argentinos Juniors', '2026-08-24T23:59:00-03:00', 'played', 1, 1),
    (6, 'Talleres', 'Rosario Central', '2026-08-24T23:59:00-03:00', 'played', 2, 2),
    (7, 'Unión', 'Sarmiento', '2026-08-28T23:59:00-03:00', 'played', 4, 1),
    (7, 'Boca Juniors', 'Lanús', '2026-08-28T23:59:00-03:00', 'played', 1, 0),
    (7, 'Deportivo Riestra', 'Vélez Sarsfield', '2026-08-29T23:59:00-03:00', 'played', 1, 1),
    (7, 'Rosario Central', 'Gimnasia La Plata', '2026-08-29T23:59:00-03:00', 'played', 1, 2),
    (7, 'Huracán', 'Estudiantes de Río Cuarto', '2026-08-29T23:59:00-03:00', 'played', 1, 1),
    (7, 'Talleres', 'Central Córdoba', '2026-08-29T23:59:00-03:00', 'played', 0, 0),
    (7, 'Atlético Tucumán', 'Belgrano', '2026-08-29T23:59:00-03:00', 'played', 0, 0),
    (7, 'Banfield', 'River Plate', '2026-08-30T23:59:00-03:00', 'played', 2, 3),
    (7, 'Argentinos Juniors', 'Aldosivi', '2026-08-30T23:59:00-03:00', 'played', 2, 1),
    (7, 'Independiente', 'Gimnasia de Mendoza', '2026-08-30T23:59:00-03:00', 'played', 0, 3),
    (7, 'Independiente Rivadavia', 'Racing', '2026-08-30T23:59:00-03:00', 'played', 3, 1),
    (7, 'Defensa y Justicia', 'Platense', '2026-08-31T23:59:00-03:00', 'played', 1, 0),
    (7, 'Estudiantes de La Plata', "Newell's Old Boys", '2026-08-31T23:59:00-03:00', 'played', 0, 0),
    (7, 'Tigre', 'Barracas Central', '2026-08-31T23:59:00-03:00', 'played', 0, 0),
    (7, 'Instituto', 'San Lorenzo', '2026-08-31T23:59:00-03:00', 'played', 1, 0),
    (8, 'Estudiantes de Río Cuarto', 'Sarmiento', '2026-09-04T23:59:00-03:00', 'played', 0, 2),
    (8, 'Belgrano', 'Huracán', '2026-09-04T23:59:00-03:00', 'played', 1, 1),
    (8, 'Platense', 'Deportivo Riestra', '2026-09-04T23:59:00-03:00', 'played', 1, 1),
    (8, 'Aldosivi', 'Banfield', '2026-09-05T23:59:00-03:00', 'played', 3, 1),
    (8, 'Gimnasia La Plata', 'Tigre', '2026-09-05T23:59:00-03:00', 'played', 2, 1),
    (8, 'Gimnasia de Mendoza', 'Boca Juniors', '2026-09-05T23:59:00-03:00', 'played', 2, 2),
    (8, 'San Lorenzo', 'Talleres', '2026-09-05T23:59:00-03:00', 'played', 1, 0),
    (8, 'Vélez Sarsfield', 'Estudiantes de La Plata', '2026-09-05T23:59:00-03:00', 'played', 1, 0),
    (8, 'Rosario Central', "Newell's Old Boys", '2026-09-06T23:59:00-03:00', 'played', 1, 1),
    (8, 'Lanús', 'Defensa y Justicia', '2026-09-06T23:59:00-03:00', 'played', 1, 0),
    (8, 'Central Córdoba', 'Independiente', '2026-09-06T23:59:00-03:00', 'played', 0, 1),
    (8, 'River Plate', 'Independiente Rivadavia', '2026-09-06T23:59:00-03:00', 'played', 3, 1),
    (8, 'Racing', 'Atlético Tucumán', '2026-09-06T23:59:00-03:00', 'played', 1, 2),
    (8, 'Barracas Central', 'Argentinos Juniors', '2026-09-07T23:59:00-03:00', 'played', 0, 0),
    (8, 'Unión', 'Instituto', '2026-09-07T23:59:00-03:00', 'played', 3, 2),
    (9, "Newell's Old Boys", 'Vélez Sarsfield', '2026-09-11T23:59:00-03:00', 'played', 1, 1),
    (9, 'Defensa y Justicia', 'Gimnasia de Mendoza', '2026-09-11T23:59:00-03:00', 'played', 2, 0),
    (9, 'Boca Juniors', 'Central Córdoba', '2026-09-11T23:59:00-03:00', 'played', 3, 1),
    (9, 'Independiente Rivadavia', 'Aldosivi', '2026-09-12T23:59:00-03:00', 'played', 4, 3),
    (9, 'Estudiantes de La Plata', 'Platense', '2026-09-12T23:59:00-03:00', 'played', 2, 1),
    (9, 'Atlético Tucumán', 'River Plate', '2026-09-12T23:59:00-03:00', 'played', 1, 2),
    (9, 'Talleres', 'Unión', '2026-09-12T23:59:00-03:00', 'played', 2, 1),
    (9, 'Sarmiento', 'Belgrano', '2026-09-13T23:59:00-03:00', 'played', 1, 1),
    (9, 'Tigre', 'Rosario Central', '2026-09-13T23:59:00-03:00', 'played', 0, 1),
    (9, 'Argentinos Juniors', 'Gimnasia La Plata', '2026-09-13T23:59:00-03:00', 'played', 1, 1),
    (9, 'Independiente', 'San Lorenzo', '2026-09-13T23:59:00-03:00', 'played', 1, 1),
    (9, 'Huracán', 'Racing', '2026-09-13T23:59:00-03:00', 'played', 2, 1),
    (9, 'Deportivo Riestra', 'Lanús', '2026-09-14T19:00:00-03:00', 'scheduled', None, None),
    (9, 'Banfield', 'Barracas Central', '2026-09-14T19:00:00-03:00', 'scheduled', None, None),
    (9, 'Instituto', 'Estudiantes de Río Cuarto', '2026-09-14T21:15:00-03:00', 'scheduled', None, None),
    (10, 'Central Córdoba', 'Defensa y Justicia', '2026-09-18T19:00:00-03:00', 'scheduled', None, None),
    (10, 'Racing', 'Sarmiento', '2026-09-18T21:15:00-03:00', 'scheduled', None, None),
    (10, 'Gimnasia La Plata', 'Banfield', '2026-09-19T14:30:00-03:00', 'scheduled', None, None),
    (10, 'Gimnasia de Mendoza', 'Deportivo Riestra', '2026-09-19T14:30:00-03:00', 'scheduled', None, None),
    (10, 'Unión', 'Independiente', '2026-09-19T16:45:00-03:00', 'scheduled', None, None),
    (10, 'River Plate', 'Huracán', '2026-09-19T19:00:00-03:00', 'scheduled', None, None),
    (10, 'Instituto', 'Talleres', '2026-09-19T21:15:00-03:00', 'scheduled', None, None),
    (10, 'San Lorenzo', 'Boca Juniors', '2026-09-20T14:45:00-03:00', 'scheduled', None, None),
    (10, 'Rosario Central', 'Argentinos Juniors', '2026-09-20T17:00:00-03:00', 'scheduled', None, None),
    (10, 'Platense', "Newell's Old Boys", '2026-09-20T17:00:00-03:00', 'scheduled', None, None),
    (10, 'Belgrano', 'Estudiantes de Río Cuarto', '2026-09-20T19:15:00-03:00', 'scheduled', None, None),
    (10, 'Vélez Sarsfield', 'Tigre', '2026-09-20T21:30:00-03:00', 'scheduled', None, None),
    (10, 'Aldosivi', 'Atlético Tucumán', '2026-09-21T14:30:00-03:00', 'scheduled', None, None),
    (10, 'Barracas Central', 'Independiente Rivadavia', '2026-09-21T19:00:00-03:00', 'scheduled', None, None),
    (10, 'Lanús', 'Estudiantes de La Plata', '2026-09-21T21:15:00-03:00', 'scheduled', None, None),
    (11, 'Independiente', 'Instituto', '2026-10-02T19:15:00-03:00', 'scheduled', None, None),
    (11, 'Independiente Rivadavia', 'Gimnasia La Plata', '2026-10-02T21:30:00-03:00', 'scheduled', None, None),
    (11, 'Defensa y Justicia', 'San Lorenzo', '2026-10-03T14:45:00-03:00', 'scheduled', None, None),
    (11, 'Atlético Tucumán', 'Barracas Central', '2026-10-03T17:00:00-03:00', 'scheduled', None, None),
    (11, "Newell's Old Boys", 'Lanús', '2026-10-03T17:00:00-03:00', 'scheduled', None, None),
    (11, 'Argentinos Juniors', 'Tigre', '2026-10-03T19:15:00-03:00', 'scheduled', None, None),
    (11, 'Huracán', 'Aldosivi', '2026-10-03T21:30:00-03:00', 'scheduled', None, None),
    (11, 'Sarmiento', 'River Plate', '2026-10-04T14:45:00-03:00', 'scheduled', None, None),
    (11, 'Talleres', 'Belgrano', '2026-10-04T17:00:00-03:00', 'scheduled', None, None),
    (11, 'Boca Juniors', 'Unión', '2026-10-04T19:15:00-03:00', 'scheduled', None, None),
    (11, 'Estudiantes de Río Cuarto', 'Racing', '2026-10-04T21:30:00-03:00', 'scheduled', None, None),
    (11, 'Deportivo Riestra', 'Central Córdoba', '2026-10-05T16:45:00-03:00', 'scheduled', None, None),
    (11, 'Estudiantes de La Plata', 'Gimnasia de Mendoza', '2026-10-05T19:00:00-03:00', 'scheduled', None, None),
    (11, 'Vélez Sarsfield', 'Platense', '2026-10-05T19:00:00-03:00', 'scheduled', None, None),
    (11, 'Banfield', 'Rosario Central', '2026-10-05T21:15:00-03:00', 'scheduled', None, None),
)

def _embedded_bootstrap_records() -> list[dict]:
    out: list[dict] = []
    for round_no, home, away, scheduled_at, status, home_score, away_score in _BOOTSTRAP_SEED:
        prefix = "SEED" if status == "played" else "SEED-SCHED"
        out.append({
            "match_id": f"{prefix}-F{round_no:02d}-{slug(home)}-{slug(away)}",
            "round": round_no,
            "home": home,
            "away": away,
...
class PublicScrapingProvider:
    ...
    def _load_bootstrap(self) -> tuple[list[dict], str | None]:
        ...
        """
        embedded = _embedded_bootstrap_records()
